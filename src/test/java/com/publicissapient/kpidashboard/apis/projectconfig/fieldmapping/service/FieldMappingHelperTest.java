...
class FieldMappingHelperTest {
	@InjectMocks FieldMappingHelper fieldMappingHelper;
	...
	void testGetFieldMappingField() throws NoSuchFieldException, IllegalAccessException {
		Object result =
				FieldMappingHelper.getFieldMappingField(
						scrumFieldMapping, FieldMapping.class, "sprintName");
	...
	void testGetAccessibleFieldHistory() throws NoSuchFieldException, IllegalAccessException {
		List<ConfigurationHistoryChangeLog> result =
				FieldMappingHelper.getAccessibleFieldHistory(scrumFieldMapping, "sprintName");
		ConfigurationHistoryChangeLog configurationHistoryChangeLog =
				new ConfigurationHistoryChangeLog(
						"", "customField", "currentUser", LocalDateTime.now().toString());
		List<ConfigurationHistoryChangeLog> configurationHistoryChangeLogList = new ArrayList<>();
	...
	@Test
	void testGetFieldMappingHistory_NodeSpecific()
		...
		List<ConfigurationHistoryChangeLog> result =
				FieldMappingHelper.getFieldMappingHistory(
						scrumFieldMapping, "startDateCountKPI150", "nodeId", true);
	...
	void testGetFieldMappingData() throws NoSuchFieldException, IllegalAccessException {
		Object result =
				FieldMappingHelper.getFieldMappingData(
						scrumFieldMapping, FieldMapping.class, "sprintName", null, false);
		Assertions.assertEquals("customfield_12700", result);
	}

	@Test
	void testGetFieldMappingData_NodeSpecific_WithoutHistory()
			throws NoSuchFieldException, IllegalAccessException {
		Object result =
				FieldMappingHelper.getFieldMappingData(
						scrumFieldMapping, FieldMapping.class, "startDateCountKPI150", "nodeId", true);
	...
	void testGetFieldMappingData_NodeSpecific() throws NoSuchFieldException, IllegalAccessException {
		...
		Object result =
				FieldMappingHelper.getFieldMappingData(
						scrumFieldMapping, FieldMapping.class, "startDateCountKPI150", "node1", true);
						...
						fieldMappingStructureList.stream()
								.filter(
										fieldMappingStructure ->
												fieldMappingStructure
														.getFieldName()
														.equalsIgnoreCase("rootCauseIdentifier"))
								.toList()
								.get(0));
	...
	void testGenerateAdditionalFilters() {
		...
		Object result =
				FieldMappingHelper.generateAdditionalFilters(additonalValue, "additionalFilterConfig");
	...
	void testNotToGenerateAdditionalFilters() {
		Object result =
				FieldMappingHelper.generateAdditionalFilters(new ArrayList<>(), "additionalFilterConfg");
	...
	void testGenerateHistoryForNestedFields() throws NoSuchFieldException, IllegalAccessException {
		...
		FieldMappingHelper.generateHistoryForNestedFields(
				List.of(response), response, fieldMappingStructureList.get(0), scrumFieldMapping);
	}

	@Test
	void testSetMappingResponseWithGeneratedField()
			throws NoSuchFieldException, IllegalAccessException {
		FieldMappingHelper.setMappingResponseWithGeneratedField(
				new FieldMappingResponse(
						"fieldName",
						"originalValue",
						"previousValue",
						List.of(
								new ConfigurationHistoryChangeLog(
										"changedFrom", "changedTo", "changedBy", "updatedOn", "releaseNodeId"))),
				scrumFieldMapping);
	}
	...
	void testSetNodeSpecificFields() throws NoSuchFieldException, IllegalAccessException {
		...
		FieldMappingHelper.setNodeSpecificFields(
				fieldMappingStructureList.get(0), response, scrumFieldMapping, "nodeId", null);
	}
	...
	void testRemoveDuplicateFieldsFromResponse() {
		...
		FieldMappingHelper.removeDuplicateFieldsFromResponse(
				Arrays.asList(response, response2, response3), responseHashMap);
	...
	void testCreateHistoryChangeLog() {
		ConfigurationHistoryChangeLog result =
				FieldMappingHelper.createHistoryChangeLog(
						...
						new FieldMappingResponse(
								...
								List.of(
										new ConfigurationHistoryChangeLog(
												"changedFrom", "changedTo", "changedBy", "updatedOn", "releaseNodeId"))),
						fieldMappingStructureList.get(0),
						"loggedInUser");
	...
	void testSetNodeSpecificField() throws NoSuchFieldException, IllegalAccessException {
		...
		FieldMappingStructure startDateCountKPI150 =
				fieldMappingStructureList.stream()
						.filter(
								fieldMappingStructure ->
										fieldMappingStructure.getFieldName().equalsIgnoreCase("startDateCountKPI150"))
						.toList()
						.get(0);
		Update update = new Update();
		FieldMappingHelper.setNodeSpecificFields(
				startDateCountKPI150, mappingResponse, scrumFieldMapping, "node1", update);
	...
	void testNestedFieldsPresent() throws NoSuchFieldException, IllegalAccessException {
		...
		fieldMappingHelper.generateHistoryForNestedFields(
				responseList, response, mappingStructure, fieldMapping);
	...
	void testNoNestedFields() throws NoSuchFieldException, IllegalAccessException {
		...
		fieldMappingHelper.generateHistoryForNestedFields(
				new ArrayList<>(), response, mappingStructure, fieldMapping);
