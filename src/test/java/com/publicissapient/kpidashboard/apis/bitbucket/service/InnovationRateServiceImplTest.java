...
public class InnovationRateServiceImplTest {
	...
	@InjectMocks
	InnovationRateServiceImpl innovationRateService;
	@Mock
	...
	public void getQualifierType() {
		assertThat("KPI name: ", innovationRateService.getQualifierType(), equalTo("INNOVATION_RATE"));
	}
	...
	public void getKpiData() throws ApplicationException {
		...
		try {
			KpiElement kpiElement = innovationRateService.getKpiData(kpiRequest, kpiRequest.getKpiList().get(0),
	...
	public void calculateKPIMetrics() {
		assertThat("Value: ", innovationRateService.calculateKPIMetrics(commitMap), equalTo(null));
	}
