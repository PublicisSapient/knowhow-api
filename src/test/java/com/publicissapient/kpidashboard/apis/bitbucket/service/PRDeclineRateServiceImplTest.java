...
public class PRDeclineRateServiceImplTest {
	...
	public void calculateKPIMetrics() {
		assertThat("Value: ", declineRateService.calculateKPIMetrics(commitMap), equalTo(null));
	}
	...
	public void testCalculateKpiValue() {
		...
		String kpiName = "PR_DECLINE_RATE";

		Double expectedValue = declineRateService.calculateKpiValueForDouble(valueList, kpiName);
		Double actualValue = declineRateService.calculateKpiValue(valueList, kpiName);

		assertThat("Calculated KPI Value: ", actualValue, equalTo(expectedValue));
	}
