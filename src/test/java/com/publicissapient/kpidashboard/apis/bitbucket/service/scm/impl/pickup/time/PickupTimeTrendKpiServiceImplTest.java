...
class PickupTimeTrendKpiServiceImplTest {
	...
	@InjectMocks private PickupTimeTrendKpiServiceImpl service;
	...
	void testPrepareUserValidationData_WithMultipleUsers() throws Exception {
		...
		ScmMergeRequests mr2 =
				createMergeRequest(
						LocalDateTime.of(2024, 1, 11, 9, 0), LocalDateTime.of(2024, 1, 12, 15, 0));
	...
	private List<RepoToolValidationData> invokePrepareUserValidationData(
		...
		Method method =
				PickupTimeTrendKpiServiceImpl.class.getDeclaredMethod(
