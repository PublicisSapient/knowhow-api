...
public class ScmUserServiceImplTest {
	...
	@InjectMocks private ScmUserServiceImpl scmUserService;
	...
	public void setUp() {
		...
		expectedRepoToolResult =
				realObjectMapper.createArrayNode().add("user1@example.com").add("user2@example.com");
	}
	...
	public void testGetScmUsersRepoDisabled() {
		...
		Set<String> expectedIdentifiers =
				new HashSet<>(Arrays.asList("user1@example.com", "user2@example.com"));
