...
public class ScmRepositoryServiceImplTest {
	...
	@InjectMocks private ScmRepositoryServiceImpl scmRepositoryService;
	...
	public void testGetScmRepositoryListByConnectionId_EmptyList() {
		when(scmReposRepository.findAllByConnectionId(connectionId))
				.thenReturn(Collections.emptyList());
		when(scmConnectionTraceLogRepository.findByConnectionId(connectionId.toString()))
				.thenReturn(Optional.empty());
		ScmConnectionMetaDataDTO result =
				scmRepositoryService.getScmRepositoryListByConnectionId(connectionId);
