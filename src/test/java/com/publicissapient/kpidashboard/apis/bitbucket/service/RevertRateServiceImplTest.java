...
public class RevertRateServiceImplTest {
	...
	public void setup() {
		...
		kpiRequest = kpiRequestFactory.findKpiRequest("kpi180");
		...
		assigneeSet.add(new Assignee("aks", "abc", new HashSet<>(Arrays.asList("abc@gmail.com"))));
		assigneeSet.add(new Assignee("llid", "def", new HashSet<>(Arrays.asList("def@gmail.com"))));
	...
	public void calculateKPIMetrics() {
		assertThat("Value: ", revertRateService.calculateKPIMetrics(commitMap), equalTo(null));
	}
