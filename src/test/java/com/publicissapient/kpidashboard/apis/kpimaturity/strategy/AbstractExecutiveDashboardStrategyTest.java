...
public class AbstractExecutiveDashboardStrategyTest {
	...
	@Mock private KanbanKpiMaturity toolKpiMaturity;
	...
	private static class DummyStrategy extends AbstractExecutiveDashboardStrategy {
		...
		public DummyStrategy(
				...
				KanbanKpiMaturity toolKpiMaturity,
		...
		@Override
		protected KpiMaturityResponseDTO fetchDashboardData(KpiRequest kpiRequest) {
			if (shouldSleep) {
				try {
			...
			return KpiMaturityResponseDTO.builder()
					.data(KpiMaturityDashboardDataDTO.builder().build())
					.build();
		}
	...
	public void testGetExecutiveDashboard_Success() {
		...
		KpiMaturityResponseDTO result = testStrategy.getExecutiveDashboard(request);
