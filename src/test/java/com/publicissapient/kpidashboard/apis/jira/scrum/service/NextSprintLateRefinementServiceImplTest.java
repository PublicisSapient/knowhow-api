...
public class NextSprintLateRefinementServiceImplTest {
	...
	@InjectMocks private NextSprintLateRefinementServiceImpl futureSprintLateRefinementService;
	...
	public void testGetKpiDataProject_activeSprint() throws ApplicationException {
		...
		when(jiraIssueRepository.findIssueByNumberWithAdditionalFilter(any(), any()))
				.thenReturn(storyList);
		when(jiraIssueRepository.findBySprintID(any())).thenReturn(storyList);
		try {
			KpiElement kpiElement =
					futureSprintLateRefinementService.getKpiData(
							kpiRequest,
	...
	public void testGetQualifierType() {
		assertThat(
				futureSprintLateRefinementService.getQualifierType(),
				equalTo("NEXT_SPRINT_LATE_REFINEMENT"));
	}
