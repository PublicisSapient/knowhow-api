...
public class NextSprintLateRefinementServiceImplTest {
    ...
    @InjectMocks
    private NextSprintLateRefinementServiceImpl futureSprintLateRefinementService;
    ...
    public void testGetQualifierType() {
        assertThat(futureSprintLateRefinementService.getQualifierType(), equalTo("NEXT_SPRINT_LATE_REFINEMENT"));
    }
