...
public class FlowDistributionSlingshotServiceImplTest {
	...
	@InjectMocks private FlowDistributionSlingshotServiceImpl flowDistributionSlingshotService;
	...
	public void getQualifierType() {
		assertThat(
				flowDistributionSlingshotService.getQualifierType(),
				equalTo(KPICode.FLOW_DISTRIBUTION_SLINGSHOT.name()));
	}
	...
	public void testGetQualifierType() {
		assertThat(
				flowDistributionSlingshotService.getQualifierType(),
				equalTo("FLOW_DISTRIBUTION_SLINGSHOT"));
	}
