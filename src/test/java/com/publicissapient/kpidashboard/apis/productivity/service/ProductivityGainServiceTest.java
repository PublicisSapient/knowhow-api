...
class ProductivityGainServiceTest {
	...
	public void when_HierarchyLevelsDataCannotBeObtained_Expect_InternalServerErrorIsThrown() {
		...
		assertThrows(
				...
				() ->
						productivityGainServiceImpl.processProductivityCalculationRequest(
	...
	@Test
	public void
			when_ProductivityGainConfigContainsErrors_Expect_ProcessingProductivityGainRequestThrowsInternalServerErrorException() {
		when(productivityGainConfig.getConfigValidationIssues())
				.thenReturn(Set.of("Test config issue"));
	...
	private void initializeProductivityGainRequestMocks() throws EntityNotFoundException {
		...
		when(jiraIterationServiceR.process(any(KpiRequest.class)))
				.thenAnswer(
						invocationOnMock -> {
							KpiRequest invocationArgument = invocationOnMock.getArgument(0);
							return invocationArgument.getKpiList().stream()
	...
	private static ProductivityGainCalculationRequestDTO createCalculateProductivityRequest(
			int level, String label, String parentId) {
		ProductivityGainCalculationRequestDTO productivityGainCalculationRequestDTO =
				new ProductivityGainCalculationRequestDTO();
	...
	private static List<ProductivityGainCalculationRequestDTO>
			provideTestCalculateProductivityRequest() {
		ProductivityGainCalculationRequestDTO productivityGainCalculationRequestDTO =
				new ProductivityGainCalculationRequestDTO();
		...
		ProductivityGainCalculationRequestDTO productivityGainCalculationRequestDTO1 =
				new ProductivityGainCalculationRequestDTO();
		...
		ProductivityGainCalculationRequestDTO productivityGainCalculationRequestDTO2 =
				new ProductivityGainCalculationRequestDTO();
