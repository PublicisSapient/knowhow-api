...
public class ReleaseEpicProgressServiceImpl extends JiraReleaseKPIService {
	 ...
	 *
	 * @param latestRelease releaseLeafNodeList
			...
			if (CollectionUtils.isNotEmpty(releaseIssues)
				...
				Map<String, String> epicWiseIssueSize =
						createDataCountGroupMap(
								releaseIssues, jiraIssueReleaseStatus, epicIssues, fieldMapping, filterDataList);
	...
	public Map<String, Object> fetchKPIDataFromDb(
		...
		if (null != leafNode) {
			...
			List<JiraIssue> releaseIssues =
					ReleaseKpiHelper.getFilteredReleaseJiraIssuesFromBaseClass(
							getBaseReleaseJiraIssues(), getBaseReleaseSubTask());
