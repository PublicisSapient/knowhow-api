...
public class JiraNonTrendKPIServiceFactory {
	private static final Map<String, NonTrendKPIService> JIRA_NONTREND_SERVICE_CACHE =
			new HashMap<>();
	@Autowired private List<NonTrendKPIService> services;
	...
	public static NonTrendKPIService getJiraKPIService(String type) throws ApplicationException {
		...
		if (service == null) {
			throw new ApplicationException(
					NonTrendKPIService.class, "Jira Non Trend KPI Service Factory not initalized");
		}
		return service;
	}
