 ...
 * <p>
 * Tracks estimation quality by counting stories without estimation values. Uses
 * estimationCriteria from field mapping to determine which field to check.
 * 
 * <h3>Calculation Logic:</h3>
 * <ul>
 * <li>Count stories without estimation based on estimationCriteria</li>
 * <li>Story Point: Checks SprintIssue.storyPoints field (null or 0 =
 * missing)</li>
 * <li>Original Estimate: Checks SprintIssue.originalEstimate field (null or 0 =
 * missing)</li>
 * </ul>
 * 
 * <h3>Formula:</h3>
 ...
 * <b>Value</b> = 3<br>
 * <b>Trend</b> = (3/20) × 100 = <b>15%</b> </blockquote>
 * 
...
public class MissingEstimationStrategy extends AbstractSprintMetricStrategy {
	 ...
	 * @param estimationCriteria
	 *            Estimation criteria from field mapping (Story Point, Original
	 *            Estimate)
	 * @return Count of issues without estimation
	 */
	private int countIssuesWithMissingEstimation(Set<SprintIssue> sprintIssues, String estimationCriteria) {
		return (int) sprintIssues.stream().filter(issue -> hasMissingEstimation(issue, estimationCriteria)).count();
	}

	/**
	 * Checks if SprintIssue has missing estimation based on criteria Missing = null
	 * or 0.0 for the configured estimation field
	 *
	 * @param sprintIssue
	 *            Sprint issue
	 * @param estimationCriteria
	 *            Estimation criteria (Story Point, Original Estimate)
