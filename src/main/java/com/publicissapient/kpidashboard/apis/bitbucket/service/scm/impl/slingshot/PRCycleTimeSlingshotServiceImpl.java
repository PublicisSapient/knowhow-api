...
@Service
@AllArgsConstructor
public class PRCycleTimeSlingshotServiceImpl extends BitBucketKPIService<Double, List<Object>, Map<String, Object>> {
    ...
    public KpiElement getKpiData(KpiRequest kpiRequest, KpiElement kpiElement, Node projectNode)
        ...
        if (kpiElement.getChartType().equalsIgnoreCase("line")) {
            ...
            calculateAggregatedValueMap(
                    projectNode, nodeWiseKPIValue, KPICode.PR_CYCLE_TIME_SLINGSHOT);
    ...
    public String getQualifierType() {
        return KPICode.PR_CYCLE_TIME_SLINGSHOT.name();
    }

    @Override
    public Double calculateThresholdValue(FieldMapping fieldMapping) {
        return calculateThresholdValue(
                fieldMapping.getThresholdValueKPI209(), KPICode.PR_CYCLE_TIME_SLINGSHOT.getKpiId());
    }
    ...
    private void calculateProjectKpiTrendData(
        ...
        KpiCalculationStrategy<?> strategy =
                kpiStrategyRegistry.getStrategy(
                        KPICode.PR_CYCLE_TIME_SLINGSHOT, kpiElement.getChartType());
