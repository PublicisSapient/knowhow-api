...
@Slf4j
@AllArgsConstructor
public class ScmRevertRateServiceImpl
	 ...
	 *
	 * @param mergeRequests list of merge requests```java
	 ...
	 * @param validationDataList repo tool validation data
