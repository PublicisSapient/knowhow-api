...
@Slf4j
@ChangeUnit(id = "late_refinement", order = "11001", author = "shi6", systemVersion = "11.0.0")
public class LateRefinement {
	private static final String KPI_MASTER = "kpi_master";
	private static final String KPI_EXCEL_COLUMN_CONFIG = "kpi_column_configs";
	private static final String LATE_REFINEMENT_LINK =
			"https://knowhow.suite.publicissapient.com/wiki/spaces/PS/pages/159154188/Late+Refinement";
	...
	private static final String DOR_STATUS_TOOLTIP =
			"Workflow statuses that does not belong to DOR, DOD and Live which indicate a work item has not yet been picked up in the sprint based on the Definition of Ready (DoR)";
	private static final String REFINED_WORKITEM_TOOLTIP =
			"Provide field name to identify a refined workitem. Example: customfield_13999<hr>";
	...
	public LateRefinement(MongoTemplate mongoTemplate) {
	...
	public void addKpi187And188FieldMappings(MongoTemplate mongoTemplate) {
		// KPI 187 field
		Document jiraIssueTypesKPI187 =
				new Document()
						.append(KEY_FIELD_NAME, "jiraIssueTypeNamesKPI187")
						.append(KEY_FIELD_LABEL, ISSUE_TYPES_LABEL)
						.append(KEY_PLACE_HOLDER, ISSUE_TYPES_LABEL)
						.append(KEY_FIELD_DISPLAY_ORDER, 1)
						.append(KEY_FIELD_TYPE, CHIPS_TYPE)
						.append(KEY_FIELD_CATEGORY, ISSUE_TYPE_CATEGORY)
						.append(KEY_SECTION, ISSUE_TYPES_SECTION)
						.append(KEY_SECTION_ORDER, 1)
						.append(KEY_TOOLTIP, new Document(KEY_DEFINITION, ISSUE_TYPES_TOOLTIP))
						.append(KEY_MANDATORY, true);

		Document jiraStatusKPI187 =
				new Document()
						.append(KEY_FIELD_NAME, "jiraStatusKPI187")
						.append(KEY_FIELD_LABEL, "Status/es before DoR")
						.append(KEY_FIELD_DISPLAY_ORDER, 1)
						.append(KEY_FIELD_TYPE, CHIPS_TYPE)
						.append(KEY_FIELD_CATEGORY, WORKFLOW_CATEGORY)
						.append(KEY_SECTION, WORKFLOW_STATUS_SECTION)
						.append(KEY_SECTION_ORDER, 2)
						.append(KEY_TOOLTIP, new Document(KEY_DEFINITION, DOR_STATUS_TOOLTIP))
						.append(KEY_MANDATORY, true);

		// KPI 188 fields
		Document jiraRefinementCriteriaKPI188 =
				new Document()
						.append(KEY_FIELD_NAME, "jiraRefinementCriteriaKPI188")
						.append(KEY_FIELD_LABEL, "Refinement criteria")
						.append(KEY_FIELD_TYPE, "radiobutton")
						.append(KEY_SECTION, CUSTOM_FIELDS_SECTION)
						.append(KEY_FIELD_DISPLAY_ORDER, 1)
						...
						.append(
								KEY_OPTIONS,
								Arrays.asList(
										new Document(KEY_LABEL, CUSTOM_FIELD).append(KEY_VALUE, CUSTOM_FIELD)))
						.append(
								KEY_NESTED_FIELDS,
								Arrays.asList(
										new Document()
												.append(KEY_FIELD_NAME, "jiraRefinementByCustomFieldKPI188")
												...
												.append(KEY_FIELD_TYPE, "text")
												.append(KEY_FIELD_CATEGORY, FIELDS_CATEGORY)
												.append(KEY_FILTER_GROUP, Arrays.asList(CUSTOM_FIELD))
												.append(
														KEY_TOOLTIP, new Document(KEY_DEFINITION, REFINED_WORKITEM_TOOLTIP)),
										new Document()
												.append(KEY_FIELD_NAME, "jiraRefinementMinLengthKPI188")
										...
										new Document()
												.append(KEY_FIELD_NAME, "jiraRefinementKeywordsKPI188")
		...
		Document jiraIssueTypesKPI188 =
				new Document()
						.append(KEY_FIELD_NAME, "jiraIssueTypeNamesKPI188")
						.append(KEY_FIELD_LABEL, ISSUE_TYPES_LABEL)
						.append(KEY_PLACE_HOLDER, ISSUE_TYPES_LABEL)
						.append(KEY_FIELD_DISPLAY_ORDER, 1)
						.append(KEY_FIELD_TYPE, CHIPS_TYPE)
		...
		List<Document> fieldMap =
				Arrays.asList(
						jiraIssueTypesKPI187,
						jiraStatusKPI187,
	...
	public void addKpi187And188ToMaster(MongoTemplate mongoTemplate) {
		Document kpi187 =
				new Document()
						...
						.append(KEY_KPI_NAME, "Late Refinement (Current Sprint)")
						.append(KEY_KPI_UNIT, "Count")
						.append(KEY_IS_DELETED, "False")
						.append(KEY_DEFAULT_ORDER, 10)
						.append(KEY_KPI_CATEGORY, "Iteration")
						.append(KEY_KPI_SUB_CATEGORY, "Iteration Progress")
						.append(KEY_KPI_SOURCE, "Jira")
						.append(KEY_COMBINED_SOURCE, "Jira/Azure")
						.append(KEY_GROUP_ID, 20)
						.append(KEY_THRESHOLD_VALUE, "")
						.append(KEY_KANBAN, false)
						.append(KEY_CHART_TYPE, "CumulativeMultilineChart")
						.append(
								KEY_KPI_INFO,
								new Document()
										.append(
										...
										.append(
												...
												Arrays.asList(
														new Document()
																.append(KEY_TYPE, "link")
																.append(
																		KEY_KPI_LINK_DETAIL,
																		new Document()
																				.append(KEY_LABEL, DETAILED_INFO)
																				.append(KEY_LINK, LATE_REFINEMENT_LINK)))))
						.append(KEY_YAXIS_LABEL, "Percentage")
						.append(KEY_IS_POSITIVE_TREND, true)
						.append(KEY_SHOW_TREND, false)
						.append(KEY_IS_ADDITIONAL_FILTER, false)
						.append(KEY_KPI_WIDTH, 100)
						.append(KEY_BOX_TYPE, "chart")
						.append(KEY_CALCULATE_MATURITY, false);

		Document kpi188 =
				new Document()
						.append(KEY_KPI_ID, KPI188)
						.append(KEY_KPI_NAME, "Late Refinement (Next Sprint)")
						.append(KEY_MAX_VALUE, "")
						.append(KEY_IS_DELETED, "False")
						.append(KEY_DEFAULT_ORDER, 12)
						.append(KEY_KPI_CATEGORY, "Iteration")
						.append(KEY_KPI_SUB_CATEGORY, "Iteration Review")
						.append(KEY_KPI_SOURCE, "Jira")
						.append(KEY_COMBINED_SOURCE, "Jira/Azure")
						.append(KEY_GROUP_ID, 19)
						.append(KEY_THRESHOLD_VALUE, "")
						.append(KEY_KANBAN, false)
						...
						.append(KEY_SHOW_TREND, false)
						.append(KEY_IS_ADDITIONAL_FILTER, false)
						.append(KEY_KPI_FILTER, "multiSelectDropDown")
						.append(KEY_BOX_TYPE, "3_column")
						.append(KEY_CALCULATE_MATURITY, false);
	...
	public void addKpi188ExcelConfig(MongoTemplate mongoTemplate) {
		Document kpi188ExcelConfig =
				new Document()
						.append(KEY_BASIC_PROJECT_CONFIG_ID, null)
						.append(KEY_KPI_ID, KPI188)
						.append(
								KEY_KPI_COLUMN_DETAILS,
								Arrays.asList(
										new Document()
												.append(KEY_COLUMN_NAME, "Issue Id")
												.append(KEY_ORDER, 0)
												.append(KEY_IS_SHOWN, true)
												.append(KEY_IS_DEFAULT, true),
										new Document()
												.append(KEY_COLUMN_NAME, "Issue Description")
												.append(KEY_ORDER, 1)
												.append(KEY_IS_SHOWN, true)
												.append(KEY_IS_DEFAULT, true),
										new Document()
												.append(KEY_COLUMN_NAME, "Sprint Name")
												.append(KEY_ORDER, 2)
												.append(KEY_IS_SHOWN, true)
												.append(KEY_IS_DEFAULT, false),
										new Document()
												.append(KEY_COLUMN_NAME, "Issue Status")
												.append(KEY_ORDER, 3)
												.append(KEY_IS_SHOWN, true)
												.append(KEY_IS_DEFAULT, false),
										new Document()
												.append(KEY_COLUMN_NAME, "Issue Type")
												.append(KEY_ORDER, 4)
												.append(KEY_IS_SHOWN, true)
												.append(KEY_IS_DEFAULT, false),
										new Document()
												.append(KEY_COLUMN_NAME, "Un-Refined")
												.append(KEY_ORDER, 5)
												.append(KEY_IS_SHOWN, true)
												.append(KEY_IS_DEFAULT, false)));
		...
		mongoTemplate
				...
				.deleteMany(
						new Document(
								"$or",
								Arrays.asList(
										new Document(KEY_FIELD_NAME, "jiraIssueTypeNamesKPI187"),
		...
		mongoTemplate
				...
				.deleteMany(
						new Document(
								"$or",
								Arrays.asList(
										new Document(KEY_KPI_ID, "kpi187"), new Document(KEY_KPI_ID, KPI188))));

		// Remove KPI 188 excel config
		mongoTemplate
				.getCollection(KPI_EXCEL_COLUMN_CONFIG)
				.deleteOne(new Document(KEY_KPI_ID, KPI188));
