 ...
 */
@ChangeUnit(
		id = "r_update_kpi_column_config_kpi118_kpi183",
		order = "012203",
		author = "girpatha",
...
public class UpdateKpiColumnConfigKpi118Kpi183 {
	...
	public void execution() {
		...
		Document originalDocumentKpi118 =
				new Document()
						.append(BASIC_PROJECT_CONFIG_ID, null)
						.append(KPI_ID, KPI_118)
						.append(
								KPI_COLUMN_DETAILS,
								List.of(
										new Document(COLUMN_NAME, PROJECT_NAME)
												.append(ORDER, 1)
										...
										new Document(COLUMN_NAME, "Date")
												...
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document(COLUMN_NAME, "Pipeline Name")
												.append(ORDER, 4)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
		...
		Document originalDocumentKpi183 =
				new Document()
						.append(BASIC_PROJECT_CONFIG_ID, null)
						.append(KPI_ID, KPI_183)
						.append(
								KPI_COLUMN_DETAILS,
								List.of(
										new Document(COLUMN_NAME, PROJECT_NAME)
						...
						.append(
								...
								List.of(
										new Document(COLUMN_NAME, PROJECT_NAME)
												...
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document(COLUMN_NAME, "Job Name / Pipeline Name")
												.append(ORDER, 2)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document(COLUMN_NAME, "Date")
