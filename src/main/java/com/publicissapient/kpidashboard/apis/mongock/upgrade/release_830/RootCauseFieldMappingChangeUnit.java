								...
								Arrays.asList(
										new Document()
												...
												.append(
														TOOL_TIP,
														new Document(
																DEFINITION, " Provide customfield name to identify Root Cause.")),
										new Document()
												.append(FIELD_NAME, "rootCauseValues")
												.append(FIELD_LABEL, "Root Cause Defect Values")
												.append(FIELD_TYPE, "chips")
												.append("filterGroup", Arrays.asList(LABELS))
												.append(
														TOOL_TIP,
														new Document(
																DEFINITION, "Provide label name to identify Root Cause."))))
						.append(
								"options",
								Arrays.asList(
