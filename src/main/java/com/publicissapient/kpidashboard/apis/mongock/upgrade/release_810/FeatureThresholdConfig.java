...
public class FeatureThresholdConfig {
	...
	public void insertFieldMapping() {
		fieldMappingStructure.insertMany(
				Arrays.asList(
						createDocument("thresholdValueKPI14"),
						createDocument("thresholdValueKPI82"),
						createDocument("thresholdValueKPI111"),
						createDocument("thresholdValueKPI35"),
						createDocument("thresholdValueKPI34"),
						createDocument("thresholdValueKPI37"),
						createDocument("thresholdValueKPI28"),
						createDocument("thresholdValueKPI36"),
						createDocument("thresholdValueKPI16"),
						createDocument("thresholdValueKPI17"),
						createDocument("thresholdValueKPI38"),
						createDocument("thresholdValueKPI27"),
						createDocument("thresholdValueKPI72"),
						createDocument("thresholdValueKPI84"),
						createDocument("thresholdValueKPI11"),
						createDocument("thresholdValueKPI62"),
						createDocument("thresholdValueKPI64"),
						createDocument("thresholdValueKPI67"),
						createDocument("thresholdValueKPI157"),
						createDocument("thresholdValueKPI158"),
						createDocument("thresholdValueKPI159"),
						createDocument("thresholdValueKPI160"),
						createDocument("thresholdValueKPI164")));
	}
