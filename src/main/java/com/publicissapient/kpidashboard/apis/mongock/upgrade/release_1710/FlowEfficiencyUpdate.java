...
public class FlowEfficiencyUpdate {
        ...
        Query query =
                new Query(
                        Criteria.where("kpiId")
                                .is("kpi203"));
        Update update = new Update().set("kpiInfo.definition", "Flow efficiency is a metric commonly used in Agile and Lean methodologies to measure the proportion of time work items spend actively being worked on (value-adding time) compared to their total lead time (including waiting or idle time). It helps teams identify process bottlenecks and optimize workflow.")
                .set("kpiInfo.formula", List.of(
                        new Document("lhs", "Flow efficiency")
                                .append("operator", "division")
                                .append("operands", List.of(
    ...
    @RollbackExecution
    public void rollback() { /* rollback not needed */ }
}
