...
public class CodeQualityMetricsChangeUnit {
	...
	public void execution() {
		...
		insertKpi173();
		insertColumnConfig(
				KPI_173, Arrays.asList(PROJECT, REPO, BRANCH, DEVELOPER, DAYS_WEEKS, REWORK_RATE));
		insertKpi180();
		insertColumnConfig(
				KPI_180,
				Arrays.asList(
						PROJECT, REPO, BRANCH, AUTHOR, DAYS_WEEKS, REVERT_PR, NO_OF_MERGE, REVERT_RATE));
	}
	...
	private void insertKpi201() {
		Map<String, Object> document =
				createBaseKpiDocument(KPI_201, "Code Quality Metrics", 7, 2, PROGRESSBAR_CHART);
	...
	private void insertKpi173() {
		...
		document.put(
				"maturityRange", Arrays.asList(MATURITY_RANGE_VALUES, "80-50", "50-20", "20-5", "5-"));
	...
	private Map<String, Object> createBaseKpiDocument(
			String kpiId, String kpiName, int defaultOrder, int groupId, String chartType) {
		Map<String, Object> document = new HashMap<>();
		document.put(KPI_ID, kpiId);
