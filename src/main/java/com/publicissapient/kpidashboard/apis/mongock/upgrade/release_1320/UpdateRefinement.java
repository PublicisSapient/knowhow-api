...
@Slf4j
@ChangeUnit(id = "update_refinement", order = "13203", author = "shi6", systemVersion = "13.2.0")
public class UpdateRefinement {
	...
	public UpdateRefinement(MongoTemplate mongoTemplate) {
