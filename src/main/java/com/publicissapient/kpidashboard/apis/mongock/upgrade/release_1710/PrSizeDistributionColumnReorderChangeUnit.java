...
@ChangeUnit(
		id = "pr_size_distribution_column_reorder",
		order = "17133",
		author = "kunkambl",
		systemVersion = "17.1.0")
@RequiredArgsConstructor
public class PrSizeDistributionColumnReorderChangeUnit {
	...
	public void rollback() {
		// no-op: the document is owned by the original PrSizeDistributionKpiChangeUnit
	}
}
