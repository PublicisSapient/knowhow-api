...
@Slf4j
@ChangeUnit(
		id = "r_updated_mapping_structure",
		order = "010109",
		author = "aksshriv1",
...
public class FieldMappingStructureUpdate {
	...
	private static final String FILE_PATH_FIELD_MAPPING_LIST =
			"/json/mongock/default/field_mapping_structure_backup_10.0.0.json";

	public FieldMappingStructureUpdate(MongoTemplate mongoTemplate) {
		this.mongoTemplate = mongoTemplate;
		FieldMappingStructureDataFactory fieldMappingStructureBackupDataFactory =
				FieldMappingStructureDataFactory.newInstance(FILE_PATH_FIELD_MAPPING_LIST);
		fieldMappingStructureBackupList =
				fieldMappingStructureBackupDataFactory.getFieldMappingStructureList();
	}
	...
	public void changeSet() {
		...
		MongockUtil.saveListToDB(
				fieldMappingStructureBackupList, FIELD_MAPPING_STRUCTURE_COLLECTION, mongoTemplate);
	}
