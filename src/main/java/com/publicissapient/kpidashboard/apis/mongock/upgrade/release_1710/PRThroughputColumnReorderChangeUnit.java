...
@ChangeUnit(
		id = "pr_throughput_column_reorder",
		order = "17131",
		author = "aksshriv1",
		systemVersion = "17.1.0")
@RequiredArgsConstructor
public class PRThroughputColumnReorderChangeUnit {
	...
	public void execution() {
		Document filter = new Document(KEY_BASIC_PROJECT_CONFIG_ID, null).append(KPI_ID, KPI_208);

		Document kpiColumnConfig =
				new Document(KEY_BASIC_PROJECT_CONFIG_ID, null)
						.append(KPI_ID, KPI_208)
						.append(
	...
	public void rollback() {
		// no-op: the document is owned by the original PRThroughputKpiChangeUnit
	}
}
