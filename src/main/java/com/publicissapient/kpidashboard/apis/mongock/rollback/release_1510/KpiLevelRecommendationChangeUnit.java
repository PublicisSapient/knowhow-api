...
package com.publicissapient.kpidashboard.apis.mongock.rollback.release_1510;
...
@ChangeUnit(
		id = "kpi_level_recommendation_change_unit_rollback",
		order = "15110",
		author = "shunaray",
...
public class KpiLevelRecommendationChangeUnit {
	...
	/** Renames batch-project-level-recommendation back to batch-recommendation */
	...
	/** Renames batch-recommendation back to batch-project-level-recommendation */
	private void renameBatchRecommendationToProjectLevel() {
		log.info("Restoring batch-recommendation to batch-project-level-recommendation");
		...
		log.info("Successfully restored batch-recommendation to batch-project-level-recommendation");
	}

	/** Re-inserts KPI-level recommendation prompt details document */
