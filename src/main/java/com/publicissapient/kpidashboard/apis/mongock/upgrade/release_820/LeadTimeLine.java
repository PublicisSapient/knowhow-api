...
public class LeadTimeLine {
	...
	public boolean execution() {
		...
		mongoTemplate
				...
				.insertOne(
						new Document("fieldName", "thresholdValueKPI3")
	...
	public void rollbackOrdering() {
		...
		Document update =
				new Document(
						...
						new Document()
								...
								.append("lowerThresholdBG", null)
								.append("upperThresholdBG", null)
		...
		Document pushObjects =
				new Document(
						"$push", new Document("kpiInfo.details", new Document("$each", newDetailsObjects)));
