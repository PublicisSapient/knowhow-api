...
@ChangeUnit(
		id = "r_pr_cycle_time_forecast_model_change_unit",
		order = "17132",
		author = "aksshriv1",
...
public class PRCycleTimeForecastModelChangeUnit {
	...
	public void rollback() {
		log.info("Re-applying forecastModel to PR Cycle Time KPI (kpi209)");
		mongoTemplate
				.getCollection(KPI_MASTER_COLLECTION)
				.updateOne(
						new Document(KPI_ID_FIELD, KPICode.PR_CYCLE_TIME_SLINGSHOT.getKpiId()),
		...
		log.info("Completed re-applying forecastModel to PR Cycle Time KPI");
	}
}
