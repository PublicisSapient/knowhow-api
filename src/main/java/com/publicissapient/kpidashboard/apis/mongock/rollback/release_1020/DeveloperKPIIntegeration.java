...
@ChangeUnit(
		id = "r_developer_kpi_integeration",
		order = "010201",
		author = "shi6",
...
public class DeveloperKPIIntegeration {
	...
	public void rollBack() {
		...
		insertKpis(
				"kpi180",
				"Revert Rate",
				"The percentage of total pull requests opened that are reverts.",
				"https://psknowhow.atlassian.net/wiki/spaces/PSKNOWHOW/pages/197263361/Developer+Revert+Rate",
				levels,
				false,
				"red",
				WHITE);
	...
	public void insertKpis(
			...
			String upperThresholdBG,
			String lowerThresholdBG) {
		Document kpiDocument =
				new Document()
						...
						.append("isPositiveTrend", isPositiveTrend)
	...
	public void fieldMappingStructureDelete(String fieldName) {
		mongoTemplate
				...
				.deleteOne(new Document("fieldName", fieldName));
	}
}
