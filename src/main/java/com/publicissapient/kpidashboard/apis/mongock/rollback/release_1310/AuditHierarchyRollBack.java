...
@ChangeUnit(id = "r_audit_hierarchy", order = "013104", author = "shi6", systemVersion = "13.1.0")
public class AuditHierarchyRollBack {

	private static final String MODIFIED_DATE = "modifiedDate";

	private final MongoTemplate mongoTemplate;

	public AuditHierarchyRollBack(MongoTemplate mongoTemplate) {
