...
public class KanbanFieldMapping {
	...
	public void updateFieldMappingStruct() {
		...
		updateField(
				...
				false);
		updateField(
				JIRA_TICKET_VELOCITY_ISSUE_TYPE, ISSUE_TYPES_TO_CONSIDER, "", ISSUE_TYPES_MAPPING, false);
		updateField(
				KANBAN_CYCLE_TIME_ISSUE_TYPE, ISSUE_TYPES_TO_CONSIDER, "", ISSUE_TYPES_MAPPING, false);
		updateField(
				TICKET_DELIVERD_STATUS,
