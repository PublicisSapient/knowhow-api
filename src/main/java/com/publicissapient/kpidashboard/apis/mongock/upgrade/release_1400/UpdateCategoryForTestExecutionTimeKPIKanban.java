...
@Slf4j
@ChangeUnit(id = "update_category_mapping_for_kpi197", order = "14007", author = "rendk", systemVersion = "14.0.0")
public class UpdateCategoryForTestExecutionTimeKPIKanban {
    private final MongoTemplate mongoTemplate;
    private static final String KPI_ID = "kpi197";
    private static final String OLD_CATEGORY_ID = "categoryTwo";
    private static final String NEW_CATEGORY_ID = "quality";

    public UpdateCategoryForTestExecutionTimeKPIKanban(MongoTemplate mongoTemplate) {
