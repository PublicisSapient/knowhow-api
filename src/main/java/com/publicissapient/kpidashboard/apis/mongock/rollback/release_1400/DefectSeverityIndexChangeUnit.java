	...
	private void insertFieldMapping() {
		...
		Document severityField =
				new Document()
						...
						.append(
								TOOLTIP,
								new Document(DEFINITION, "Custom field to consider for a defect severity."))
		...
		nestedFields.add(
				new Document()
						...
						.append(
								...
								new Document(
										DEFINITION,
										"Provide field name to identify a defect severity. Example: customfield_10500 or customfield_10103<hr>")));
		...
		fieldMappings.add(
				new Document()
						...
						.append(
								TOOLTIP,
								new Document(DEFINITION, "All issue types that can have valid defect linkages"))
						.append(FIELD_DISPLAY_ORDER, 1)
		...
		fieldMappings.add(
				new Document()
						...
						.append(
								...
								new Document(
										DEFINITION,
										"Resolution types for defects that can be excluded from Defect count by Severity calculation"))
		...
		fieldMappings.add(
				new Document()
						...
						.append(PROCESSOR_COMMON, false)
						.append(
								TOOLTIP, new Document(DEFINITION, "All workflow statuses used to reject defects."))
		...
		return new Document()
				...
				.append(
						...
						new Document()
								.append(
										DEFINITION,
										"Measures the number of defects grouped by severity in an iteration")
								.append(
										"formula",
										List.of(
												new Document()
														.append(
																"lhs",
																"Defect Count By Severity=No. of defects linked to stories grouped by severity")))
								.append(
										"details",
										List.of(
												new Document()
														...
														.append(
																...
																new Document()
																		...
																		.append(
																				"link",
																				"https://knowhow.suite.publicissapient.com/wiki/spaces/PS/pages/257720322/Defect+Severity+Index+DSI")))))
