...
public class AuthenticationAndAuthorizationChangeLog {
	...
	public void changeSet() {
		...
		MongoCollection<Document> actionPolicyRuleCollection =
				getOrCreateCollection(ACTION_POLICY_RULE_COLLECTION);
	...
	private List<Document> getRoles() {
		...
		document1
				.append("roleName", "ROLE_GUEST")
				.append("displayName", "Guest")
				.append("description", "read access for the instance")
				...
				.append(
						"permissions",
						Arrays.asList(
								new Document("permissionName", "View")
										.append("operationName", "Read")
										.append("resourceName", "resource4")
										.append("createdDate", new Date())
										.append("lastModifiedDate", new Date())
										.append("isDeleted", "False")));
		...
		document2
				.append("roleName", "ROLE_SUPERADMIN")
				.append("displayName", "Super Admin")
				...
				.append(
						"permissions",
						Arrays.asList(
								new Document("permissionName", "ViewAll")
										.append("operationName", "Read")
										.append("resourceName", "resource5")
										.append("createdDate", new Date())
										.append("lastModifiedDate", new Date())
										.append("isDeleted", "False")));
		...
		document3
				.append("roleName", "ROLE_PROJECT_ADMIN")
				.append("displayName", "Project Admin")
		...
		document4
				.append("roleName", "ROLE_PROJECT_VIEWER")
				.append("displayName", "Project Viewer")
	...
	private List<Document> getActionPolicyRule() {
		return Arrays.asList(
				new Document("name", "Super Admin")
						.append("roleAllowed", "")
						.append("description", "Super Admin can do all.")
						.append("roleActionCheck", "subject.authorities.contains('ROLE_SUPERADMIN')")
						.append("condition", true)
						.append("createdDate", new Date())
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Add projects")
						.append("roleAllowed", "")
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Update projects")
						.append("roleAllowed", "")
						.append(
								"description",
				...
				new Document("name", "Delete tool")
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Cache project config")
						.append("roleAllowed", "")
						...
						.append("condition", "subject.username == resource")
						.append("createdDate", new Date())
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Global config field")
						.append("roleAllowed", "")
						.append("description", "Only ROLE_SUPERADMIN can access this resource")
						.append(
								"roleActionCheck",
								"action == 'GET_GLOBAL_CONFIG_FIELD' && resource != 'centralConfig'")
						.append("condition", true)
						.append("createdDate", new Date())
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Central Config")
						.append("roleAllowed", "")
						.append("description", "Only ROLE_SUPERADMIN can access this resource")
						.append(
								"roleActionCheck",
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Upload/Delete logo")
						.append("roleAllowed", "")
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "File Upload eng maturity master")
						.append("roleAllowed", "")
						.append(
								"description",
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "File Upload engg maturity")
						.append("roleAllowed", "")
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Processor List")
						.append("roleAllowed", "")
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Run Processor")
						.append("roleAllowed", "")
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Access request of the user")
						.append("roleAllowed", "")
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "SAVE_PROJECT_TOOL")
						.append("roleAllowed", "")
						.append(
								"description",
								"User with ROLE_PROJECT_ADMIN save the project tool if has access of it")
						.append(
								"roleActionCheck",
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "UPDATE_PROJECT_TOOL")
						.append("roleAllowed", "")
						.append(
								"description",
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "CLEAN_PROJECT_TOOL_DATA")
						.append("roleAllowed", "")
						.append(
								"description",
								"User with ROLE_PROJECT_ADMIN update the project tool if has access of it")
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "capacity tab")
						.append("roleAllowed", "")
						.append(
								"description",
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "DELETE_PROJECT")
						.append("roleAllowed", "")
						.append(
								"description",
								"User with ROLE_PROJECT_ADMIN can delete the project if granted access")
						.append(
								"roleActionCheck",
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "test Execution")
						.append("roleAllowed", "")
						.append(
								"description",
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Raise access request by the user")
						.append("roleAllowed", "")
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Connection access")
						.append("roleAllowed", "")
						.append(
				...
				new Document("name", "AD Settings")
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Show Emm history and Statistics")
						.append("roleAllowed", "")
						.append(
								"description",
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Approve User")
						.append("roleAllowed", "")
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Access Request status")
						.append("roleAllowed", "")
						.append(
								"description",
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Grant Access")
						.append("roleAllowed", "")
						.append(
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "DELETE_USER")
						.append("roleAllowed", "")
						.append(
								"description",
								"User with role ROLE_SUPERADMIN can delete the users if granted access")
						.append("roleActionCheck", "action == 'DELETE_USER'")
						.append("condition", "subject.authorities.contains('ROLE_SUPERADMIN')")
						.append("createdDate", new Date())
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Login type Configuration")
						.append("roleAllowed", "")
						...
						.append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "Fetch Sprint")
						.append("roleAllowed", "")
				...
				new Document("name", "ADD_USER")
						...
						.append(
								"description",
								"User with role ROLE_SUPERADMIN or Project Admin can add the users if granted access")
