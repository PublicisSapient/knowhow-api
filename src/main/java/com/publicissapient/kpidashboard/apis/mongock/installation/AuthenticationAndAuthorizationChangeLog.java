...
public class AuthenticationAndAuthorizationChangeLog {
	...
	private List<Document> getActionPolicyRule() {
		return Arrays.asList(
				new Document("name", "Super Admin").append("roleAllowed", "").append("description", "Super Admin can do all.")
				...
				new Document("name", "Add projects").append("roleAllowed", "")
						...
						.append("roleActionCheck", "!subject.authorities.contains('ROLE_GUEST') && action == 'ADD_PROJECT'")
				...
				new Document("name", "Update projects").append("roleAllowed", "")
						.append("description", "User with ROLE_PROJECT_ADMIN can update the project if has access of it")
						.append("roleActionCheck",
								"subject.authorities.contains('ROLE_PROJECT_ADMIN') && action == 'UPDATE_PROJECT'")
						.append("condition", "projectAccessManager.hasProjectEditPermission(resource.id, subject.getUsername())")
						.append("createdDate", new Date()).append("lastModifiedDate", new Date()).append("isDeleted", false),
				new Document("name", "Delete tool").append("roleAllowed", "").append("description",
						...
						.append("roleActionCheck", "subject.authorities.contains('ROLE_PROJECT_ADMIN') && action == 'DELETE_TOOL'")
						.append("condition", "projectAccessManager.hasProjectEditPermission(resource, subject.getUsername())")
						.append("createdDate", new Date()).append("lastModifiedDate", new Date()).append("isDeleted", false),
				...
				new Document("name", "Upload/Delete logo").append("roleAllowed", "")
						...
						.append("roleActionCheck", "resource == 'LOGO' && {'FILE_UPLOAD', 'DELETE_LOGO'}.contains(action)")
						.append("condition", "subject.authorities.contains('ROLE_SUPERADMIN')").append("createdDate", new Date())
						.append("lastModifiedDate", new Date()).append("isDeleted", false),
				new Document("name", "File Upload eng maturity master").append("roleAllowed", "")
						.append("description",
				...
				new Document("name", "Run Processor").append("roleAllowed", "")
						...
						.append("condition", "projectAccessManager.canTriggerProcessorFor(resource, subject.getUsername())")
						.append("createdDate", new Date()).append("lastModifiedDate", new Date()).append("isDeleted", false),
				new Document("name", "Access request of the user").append("roleAllowed", "")
						...
						.append("condition", "subject.authorities.contains('ROLE_SUPERADMIN') || subject.username == resource")
						.append("createdDate", new Date()).append("lastModifiedDate", new Date()).append("isDeleted", false),
				...
				new Document("name", "UPDATE_PROJECT_TOOL").append("roleAllowed", "")
						.append("description", "User with ROLE_PROJECT_ADMIN update the project tool if has access of it")
						.append("roleActionCheck",
				...
				new Document("name", "DELETE_PROJECT").append("roleAllowed", "")
						...
						.append("condition", "projectAccessManager.hasProjectEditPermission(resource, subject.getUsername())")
						.append("createdDate", new Date()).append("lastModifiedDate", new Date()).append("isDeleted", false),
				new Document("name", "test Execution").append("roleAllowed", "")
						.append("description",
				...
				new Document("name", "Connection access").append("roleAllowed", "")
						...
						.append("roleActionCheck", "!subject.authorities.contains('ROLE_GUEST') && action == 'CONNECTION_ACCESS'")
						.append("condition", "true").append("createdDate", new Date()).append("lastModifiedDate", new Date())
						.append("isDeleted", false),
				new Document("name", "AD Settings").append("roleAllowed", "")
						...
						.append("condition", "subject.authorities.contains('ROLE_SUPERADMIN')").append("createdDate", new Date())
						.append("lastModifiedDate", new Date()).append("isDeleted", false),
				new Document("name", "Show Emm history and Statistics").append("roleAllowed", "")
						.append("description",
				...
				new Document("name", "Access Request status").append("roleAllowed", "")
						.append("description", "User with ROLE_PROJECT_ADMIN and ROLE_SUPERADMIN can see access request")
						.append("roleActionCheck", "action == 'ACCESS_REQUEST_STATUS'")
						.append("condition", "subject.authorities.contains('ROLE_PROJECT_ADMIN')").append("createdDate", new Date())
						.append("lastModifiedDate", new Date()).append("isDeleted", false),
				...
				new Document("name", "Login type Configuration").append("roleAllowed", "")
						...
						.append("roleActionCheck", "action == 'CONFIGURE_LOGIN_TYPE' || action == 'GET_LOGIN_TYPES_CONFIG'")
						.append("condition", "subject.authorities.contains('ROLE_SUPERADMIN')").append("createdDate", new Date())
						.append("lastModifiedDate", new Date()).append("isDeleted", false),
