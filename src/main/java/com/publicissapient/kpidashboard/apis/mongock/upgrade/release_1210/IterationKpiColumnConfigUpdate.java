 ...
 */
@ChangeUnit(
		id = "iteration_kpi_column_config_update",
		order = "12105",
		author = "prijain3",
...
public class IterationKpiColumnConfigUpdate {
	...
	public void execution() {
				...
				new Document(
						...
						new Document(
								...
								List.of(
										...
										new Document()
												.append(COLUMN_NAME, ISSUE_TYPE)
												.append(ORDER, 2)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document()
												.append(COLUMN_NAME, ISSUE_DESCRIPTION)
												.append(ORDER, 3)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document()
												.append(COLUMN_NAME, SIZE)
												.append(ORDER, 4)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document()
												.append(COLUMN_NAME, PRIORITY)
												.append(ORDER, 5)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document()
												...
												.append(IS_DEFAULT, true),
										new Document()
												.append(COLUMN_NAME, ISSUE_STATUS)
												.append(ORDER, 7)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document()
												.append(COLUMN_NAME, "Due Date")
												.append(ORDER, 8)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true))));
						...
						new Document(
								...
								List.of(
										...
										new Document()
												...
												.append(IS_DEFAULT, true),
										new Document()
												.append(COLUMN_NAME, "Root Cause List")
												.append(ORDER, 5)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document()
										...
										new Document()
												...
												.append(IS_DEFAULT, true),
										new Document()
												.append(COLUMN_NAME, "Created during Iteration")
												.append(ORDER, 8)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true))));
		...
		List.of("kpi176", "kpi124", "kpi128")
				.forEach(
						kpiId -> {
							Document filter2 = new Document(KPI_ID, kpiId);
							Document categoryColumn =
									new Document(
											"$push",
											new Document(
													KPI_COLUMN_DETAILS,
													new Document()
															.append(COLUMN_NAME, "Category")
															.append(ORDER, 15)
															.append(IS_SHOWN, true)
															.append(IS_DEFAULT, true)));
						...
						new Document(
								...
								List.of(
										...
										new Document()
												...
												.append(IS_DEFAULT, true),
										new Document()
												.append(COLUMN_NAME, "Planned Completion Date (Due Date)")
												.append(ORDER, 5)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document()
												.append(COLUMN_NAME, "Actual Completion Date")
												.append(ORDER, 6)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document()
												.append(COLUMN_NAME, "Remaining Estimate")
												.append(ORDER, 7)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document()
												.append(COLUMN_NAME, "Potential Delay(in days)")
												.append(ORDER, 8)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document()
												.append(COLUMN_NAME, "Predicted Completion Date")
												.append(ORDER, 9)
												.append(IS_SHOWN, true)
												.append(IS_DEFAULT, true),
										new Document()
