...
public class AlignKpiMaturityRangeToKEM {
	...
	@Execution
	public void execute() {
		Map<String, List<String>> maturityRangeMap = Map.of(
				"kpi72", List.of("-60", "60-79", "80-94", "95-105", "105-"),
				"kpi82", List.of("-60", "60-79", "80-89", "90-94", "95-"),
				"kpi111", List.of("-50", "50-40", "40-20", "20-10", "10-"),
				"kpi166", List.of("24-", "4-24", "1-4", "0.5-1", "-0.5"),
				KPI_PI_PREDICTABILITY, List.of("-50", "51-70", "71-80", "81-90", "91-"),
				"kpi118", List.of("-2", "2-4", "5-10", "11-20", "20-"));
	...
	public void rollback() {
		Map<String, List<String>> maturityRangeMap = Map.of(
				"kpi72", List.of("-40", "40-60", "60-75", "75-90", "90-"),
	...
	private void updateMaturityRanges(Map<String, List<String>> maturityRangeMap, boolean calculateMaturityValue) {
		...
		for (Map.Entry<String, List<String>> entry : maturityRangeMap.entrySet()) {
			...
			if (kpiId.equalsIgnoreCase(KPI_PI_PREDICTABILITY)) {
				bulkOperations.add(new UpdateOneModel<>(filter, set("calculateMaturity", calculateMaturityValue)));
			}
		}
