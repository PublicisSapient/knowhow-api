...
public class InnovationRateKpi {
	...
	public void insertKpi185() {
		Document kpiDocument =
				new Document()
						.append("kpiId", "kpi185")
						.append("kpiName", "Innovation Rate")
						.append("maxValue", "")
						.append("kpiUnit", "%")
						.append("isDeleted", false)
						.append("defaultOrder", 9)
						.append("groupId", 2)
						...
						.append("xAxisLabel", "Days/Weeks/Months")
	...
	public void fieldMappingStructureInsert() {
		Document thresholdValueMapping =
				new Document("fieldName", "thresholdValueKPI185")
