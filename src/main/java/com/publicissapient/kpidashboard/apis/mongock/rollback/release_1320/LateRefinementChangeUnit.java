...
public class LateRefinementChangeUnit {
	...
	public static final String KPI_INFO_DETAILS_0_KPI_LINK_DETAIL_LINK =
			"kpiInfo.details.0.kpiLinkDetail.link";
	public static final String URL_DOC =
			"https://knowhow.suite.publicissapient.com/wiki/spaces/PS/pages/159154188/Sprint+Readiness";
	public static final String URL_DOC_R_C =
			"https://knowhow.tools.publicis.sapient.com/wiki/kpi187-Late+Refinemnt+Current+Sprint";
	public static final String URL_DOC_R_F =
	...
	public void changeSet() {
		...
		Update rollback187 =
				new Update()
						.set(KPI_NAME, "Late Refinement (Current Sprint)")
		...
		Update rollback188 =
				new Update()
						.set(KPI_NAME, "Late Refinement (Next Sprint)")
	...
	private void updateKpi187And188ToMaster(MongoTemplate mongoTemplate) {
		...
		Update update187 =
				new Update()
						.set(KPI_NAME, "Sprint Readiness (Current Sprint)")
		...
		Update update188 =
				new Update()
						.set(KPI_NAME, "Sprint Readiness (Next Sprint)")
						.set(KPI_INFO_DETAILS_0_KPI_LINK_DETAIL_LINK, URL_DOC);
