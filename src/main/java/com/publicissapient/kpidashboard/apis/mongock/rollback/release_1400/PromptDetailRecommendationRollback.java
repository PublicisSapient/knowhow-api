...
public class PromptDetailRecommendationRollback {
	...
	public PromptDetailRecommendationRollback(MongoTemplate mongoTemplate) {
	...
	public void execution() {
		...
		collection.deleteMany(new Document("key",
				new Document("$in", Arrays.asList(KPI_CORRELATION_ANALYSIS_REPORT, KPI_RECOMMENDATION_PROMPT))));
