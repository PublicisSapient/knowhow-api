...
@ChangeUnit(
		id = "deployment_frequency_slingshot_kpi_insert",
		order = "17142",
		author = "knowhow",
		systemVersion = "17.1.0")
public class DeploymentFrequencySlingshotChangeUnit {
	...
	public void insertFieldMappingStructure(MongoTemplate mongoTemplate) {
		Document fieldMapping =
				new Document()
						.append(FIELD_NAME, "thresholdValueKPI213")
	...
	public void rollback(MongoTemplate mongoTemplate) {
		...
		mongoTemplate
				...
				.deleteOne(new Document(FIELD_NAME, "thresholdValueKPI213"));
	}
}
