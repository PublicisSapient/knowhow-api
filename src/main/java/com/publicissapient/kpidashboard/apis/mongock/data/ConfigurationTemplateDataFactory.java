...
public class ConfigurationTemplateDataFactory {
	private static final String FILE_PATH_CONFIGURATION_TEMPLATE_LIST =
			"/json/mongock/default/configuration_template.json";
	...
	private void init(String filePath) {
		try {
			String resultPath =
					StringUtils.isEmpty(filePath) ? FILE_PATH_CONFIGURATION_TEMPLATE_LIST : filePath;
			...
			configurationTemplateList =
					mapper.readValue(
							inputStream, new TypeReference<List<ConfigurationTemplateDocument>>() {});
		} catch (IOException e) {
