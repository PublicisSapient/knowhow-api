...
@ChangeUnit(id = "r_forecast_model_update", order = "14105", author = "shunaray", systemVersion = "14.1.0")
public class ForecastModelUpdateChangeUnit {
	...
	public void rollback() {
        ...
        updateForecastModel(KPICode.SPRINT_VELOCITY.getKpiId(), ForecastingModel.EXPONENTIAL_SMOOTHING.getName());
        updateForecastModel(KPICode.SPRINT_PREDICTABILITY.getKpiId(), ForecastingModel.EXPONENTIAL_SMOOTHING.getName());
        updateForecastModel(KPICode.SPRINT_CAPACITY_UTILIZATION.getKpiId(), ForecastingModel.EXPONENTIAL_SMOOTHING.getName());
        updateForecastModel(KPICode.COMMITMENT_RELIABILITY.getKpiId(), ForecastingModel.EXPONENTIAL_SMOOTHING.getName());
        updateForecastModel(KPICode.SCOPE_CHURN.getKpiId(), ForecastingModel.EXPONENTIAL_SMOOTHING.getName());
