...
@ChangeUnit(
		id = "time_to_first_review_column_reorder",
		order = "17132",
		author = "kunkambl",
		systemVersion = "17.1.0")
@RequiredArgsConstructor
public class TimeToFirstReviewColumnReorderChangeUnit {
	...
	public void execution() {
		Document filter = new Document(KEY_BASIC_PROJECT_CONFIG_ID, null).append(KPI_ID, KPI_210);

		Document kpiColumnConfig =
				new Document(KEY_BASIC_PROJECT_CONFIG_ID, null)
						.append(KPI_ID, KPI_210)
						.append(
	...
	public void rollback() {
		// no-op: the document is owned by the original TimeToFirstReviewChangeUnit
	}
}
