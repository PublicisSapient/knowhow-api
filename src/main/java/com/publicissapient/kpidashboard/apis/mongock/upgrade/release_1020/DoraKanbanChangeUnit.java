 ...
 * @author shunaray
 */
@ChangeUnit(id = "dora_kanban_kpi", order = "10202", author = "shunaray", systemVersion = "10.2.0")
public class DoraKanbanChangeUnit {
	...
	public void insertDoraKanban() {
		List<Document> kpiDocuments =
				List.of(
						new Document()
								.append(KPI_ID, "kpi184")
								.append("kpiName", "Change Failure Rate")
								.append("isDeleted", "False")
								.append("defaultOrder", 19)
								.append("kpiCategory", "Dora")
								.append("kpiUnit", "%")
								...
								.append(
										...
										new Document()
												...
												.append(
														...
														List.of(
																new Document()
																		.append("lhs", "Change Failure Rate")
								...
								.append(
										...
										List.of(
												new Document()
														.append(LEVEL, "M5")
														.append(BG_COLOR, "#167a26")
														.append(DISPLAY_RANGE, "0-15 %"),
												new Document()
														.append(LEVEL, "M4")
														.append(BG_COLOR, "#4ebb1a")
														.append(DISPLAY_RANGE, "15-30 %"),
												new Document()
														.append(LEVEL, "M3")
														.append(BG_COLOR, "#ef7643")
														.append(DISPLAY_RANGE, "30-45 %"),
												new Document()
														.append(LEVEL, "M2")
														.append(BG_COLOR, "#f53535")
														.append(DISPLAY_RANGE, "45-60 %"),
												new Document()
														.append(LEVEL, "M1")
														.append(BG_COLOR, "#c91212")
														.append(DISPLAY_RANGE, "60 % and Above")))
								.append("combinedKpiSource", "Jenkins/Bamboo/GitHubAction/AzurePipeline/Teamcity"),
						new Document()
								.append(KPI_ID, "kpi183")
								.append("kpiName", "Deployment Frequency")
								.append("isDeleted", "False")
								...
								.append(
										...
										new Document()
												.append(
														"definition",
														"Measures how often code is deployed to production in a period")
												.append(
														"details",
														List.of(
																new Document()
