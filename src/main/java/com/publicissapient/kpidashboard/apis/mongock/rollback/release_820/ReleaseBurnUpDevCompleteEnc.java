...
public class ReleaseBurnUpDevCompleteEnc {
	...
	public void rollBackFieldMappingStructure() {
		List<String> fieldNamesToDelete =
				Arrays.asList("populateByDevDoneKPI150", "jiraDevDoneStatusKPI150");
	...
	public void insertFieldMappingStructure() {
		// Document 1
		Document document1 =
				new Document("fieldName", "populateByDevDoneKPI150")
						.append("fieldLabel", "Prediction logic")
						.append("fieldType", "toggle")
						.append("toggleLabelLeft", "Overall Completion")
						.append("toggleLabelRight", "Dev Completion*")
		...
		// Document 2
		Document document2 =
				new Document("fieldName", "jiraDevDoneStatusKPI150")
						.append("fieldLabel", "Status to identify Dev completed issues")
		...
		mongoTemplate
				.getCollection(FIELD_MAPPING_STRUCTURE)
				.insertMany(Arrays.asList(document1, document2));
	}
