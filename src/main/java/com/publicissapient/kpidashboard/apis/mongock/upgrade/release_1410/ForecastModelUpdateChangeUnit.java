...
public class ForecastModelUpdateChangeUnit {
	...
	public void execution() {
        ...
        updateForecastModel(KPICode.REPO_TOOL_CODE_COMMIT.getKpiId(), ForecastingModel.THETA_METHOD.getName());
        updateForecastModel(KPICode.REPO_TOOL_MEAN_TIME_TO_MERGE.getKpiId(), ForecastingModel.THETA_METHOD.getName());
        updateForecastModel(KPICode.PR_SIZE_OVERTIME.getKpiId(), ForecastingModel.THETA_METHOD.getName());
