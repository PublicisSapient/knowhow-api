...
public class HygieneEstimateLogic {
	...
	public void rollbackFieldMappingStructure() {
		List<String> fieldNames =
				Arrays.asList("jiraIssueTypeExcludeKPI75", "jiraIssueTypeExcludeKPI124");
		mongoTemplate
		...
		List<Document> documents =
				Arrays.asList(
						createDocument(
								...
								"Issue types to be excluded",
								"chips",
								"Issue_Type",
								"Issue Types Mapping",
								"Specify issue types to exclude from KPI calculations."),
						createDocument(
