...
@Slf4j
@ChangeUnit(
		id = "r_test_execution_time_kpi_kanban",
		order = "014102",
		author = "rendk",
...
public class TestExecutionTimeKpiKanban {
	...
	public void rollback() {
		...
		log.info(
				"Rollback executed: Re-inserted KPI: Test Execution Time Kanban (kpi197) into kpi_master and kpi_category_mapping");
	}
	...
	public void execution() {
		...
		log.info(
				"Execution executed: Deleted KPI: Test Execution Time Kanban (kpi197) from kpi_master and kpi_category_mapping");
	}
}
