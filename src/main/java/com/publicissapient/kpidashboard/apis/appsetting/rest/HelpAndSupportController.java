...
/**
 * REST controller for managing help and documentation resources. Provides endpoints to retrieve
 * help configuration and redirect to external documentation URLs.
 *
 * @author aksshriv1
 */
@RestController
...
public class HelpAndSupportController {
	...
	@ApiResponses(
			value = {
				...
				@ApiResponse(responseCode = "404", description = "API documentation URL is not configured")
			})
	...
	@ApiResponses(
			value = {
				...
				@ApiResponse(responseCode = "404", description = "Video tutorials URL is not configured")
			})
	...
	@ApiResponses(
			value = {
				...
				@ApiResponse(responseCode = "404", description = "Ticket raising URL is not configured")
			})
	...
	@ApiResponses(
			value = {
				...
				@ApiResponse(responseCode = "404", description = "Support channel URL is not configured")
			})
	...
	/**
	 * Helper method to perform URL redirection. Validates the URL and returns appropriate HTTP
	 * status.
	 *
	 * @param url the URL to redirect to
	 * @param resourceName the name of the resource being redirected to
	 * @return ResponseEntity with HTTP 302 (Found) for valid URLs or 404 (Not Found) for
	 *     invalid/empty URLs
	 */
