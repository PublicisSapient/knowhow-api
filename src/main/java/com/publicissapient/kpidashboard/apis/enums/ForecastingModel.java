...
public enum ForecastingModel {
	 ...
	 */
	EXPONENTIAL_SMOOTHING("exponentialSmoothing", "Exponential Smoothing",
			"Simple exponential smoothing for trend-based data"),

	/**
	 * Holt-Winters Exponential Smoothing: For data with trend and seasonality
	 */
	HOLT_WINTERS("holtWinters", "Holt-Winters", "Triple exponential smoothing for trend and seasonal data"),
	 ...
	 */
	LINEAR_REGRESSION("linearRegression", "Linear Regression", "Simple linear regression for trending data"),

	/**
	 * Multiple Linear Regression: For data with multiple predictors
	 */
	MULTIVARIATE_REGRESSION("multivariateRegression", "Multivariate Regression",
	 ...
	 */
	RANDOM_FOREST("randomForest", "Random Forest", "Ensemble method for complex nonlinear relationships"),

	/**
	 * Gradient Boosting: For high-performance regression
	 */
	GRADIENT_BOOSTING("gradientBoosting", "Gradient Boosting", "Boosting algorithm for high-performance prediction"),
	 ...
	 */
	LOGISTIC_GROWTH("logisticGrowth", "Logistic Growth", "S-shaped growth model for saturation effects");
