...
public enum KPIExcelColumn {
	...
	CODE_COMMIT(
			"kpi11",
			Arrays.asList("Project", "Repo", "Branch", "Days/Weeks", "No Of Commit", "No of Merge")),
	REPO_TOOL_CODE_COMMIT(
			"kpi157",
			Arrays.asList(
	...
	LEAD_TIME_KANBAN(
			...
			Arrays.asList(
					...
					"Story ID",
					"Issue Description",
					"Open to Triage(In Days)",
					"Triage to Complete (In Days)",
					"Complete TO Live (In Days)",
					"Lead Time (In Days)")),
	...
	DEFECT_COUNT_BY_PRIORITY_PIE_CHART(
			"kpi140",
			Arrays.asList(
					"Defect ID",
					"Issue Description",
	...
	CREATED_VS_RESOLVED_DEFECTS(
			...
			Arrays.asList(
					...
					"Defect Status",
					"Time Spent (in hours)",
					"Defect added after Sprint Start",
					"Resolved Status")),

	DEFECT_COUNT_BY_STATUS_PIE_CHART(
			"kpi136",
			Arrays.asList(
					"Issue Id",
					"Issue Description",
	...
	REGRESSION_AUTOMATION_COVERAGE(
			"kpi42", Arrays.asList("Sprint Name", "Test Case ID", "Automated")),

	INSPRINT_AUTOMATION_COVERAGE(
			"kpi16", Arrays.asList("Sprint Name", "Test Case ID", "Linked Story ID", "Automated")),

	UNIT_TEST_COVERAGE(
			"kpi17", Arrays.asList("Project", "Job Name / Pipeline Name", "Unit Coverage", "Weeks")),

	SONAR_VIOLATIONS(
			"kpi38",
			Arrays.asList(
					"Project", "Job Name / Pipeline Name", "Violation Type", "Violation Severity", "Weeks")),

	SONAR_TECH_DEBT(
			"kpi27",
			Arrays.asList("Project", "Job Name / Pipeline Name", "Tech Debt (in days)", "Weeks")),
	...
	CHANGE_FAILURE_RATE(
			...
			Arrays.asList(
					...
					"Job Name / Pipeline Name",
					"Total Build Count",
					"Total Build Failure Count",
					"Build Failure Percentage",
					"Weeks")),
	CHANGE_FAILURE_RATE_KANBAN(
			"kpi184",
			Arrays.asList(
					"Project",
					"Job Name / Pipeline Name",
	...
	BUILD_FREQUENCY(
			"kpi172",
			Arrays.asList(
					"Project Name", "Job Name / Pipeline Name", "Weeks", "Start Date", "Build Url")),

	TEST_EXECUTION_AND_PASS_PERCENTAGE(
			"kpi70",
			Arrays.asList(
					"Sprint Name", "Total Test", "Executed Test", "Execution %", "Passed Test", "Passed %")),
	...
	RELEASE_FREQUENCY(
			"kpi73",
			Arrays.asList(
					"Project Name", "Release Name", "Release Description", "Release End Date", "Month")),

	RELEASE_FREQUENCY_KANBAN(
			"kpi74",
			Arrays.asList(
					"Project Name", "Release Name", "Release Description", "Release End Date", "Month")),
	...
	DEPLOYMENT_FREQUENCY_KANBAN(
			"kpi183",
			Arrays.asList("Project Name", "Job Name / Pipeline Name", "Date", "Weeks", "Environment")),

	DEFECTS_WITHOUT_STORY_LINK(
			"kpi80",
			Arrays.asList("Project Name", "Priority", "Defects Without Story Link", "Issue Description")),

	TEST_WITHOUT_STORY_LINK(
			"kpi79", Arrays.asList("Project Name", "Test Case ID", "Linked to Story")),

	UNLINKED_WORK_ITEMS("kpi129", Arrays.asList("Issue Id", "Issue Description")),

	PRODUCTION_DEFECTS_AGEING(
			"kpi127",
			Arrays.asList(
					"Project Name", "Defect ID", "Issue Description", "Priority", "Created Date", "Status")),

	UNIT_TEST_COVERAGE_KANBAN(
			"kpi62",
			Arrays.asList("Project", "Job Name / Pipeline Name", "Unit Coverage", "Day/Week/Month")),

	SONAR_VIOLATIONS_KANBAN(
			"kpi64",
			Arrays.asList("Project", "Job Name / Pipeline Name", "Sonar Violations", "Day/Week/Month")),

	SONAR_TECH_DEBT_KANBAN(
			"kpi67",
			Arrays.asList(
					"Project", "Job Name / Pipeline Name", "Tech Debt (in days)", "Day/Week/Month")),

	TEST_EXECUTION_KANBAN(
			"kpi71",
			Arrays.asList(
					"Project",
					"Execution Date",
	...
	KANBAN_REGRESSION_PASS_PERCENTAGE(
			"kpi63", Arrays.asList("Project", "Day/Week/Month", "Test Case ID", "Automated")),

	OPEN_TICKET_AGING_BY_PRIORITY(
			"kpi997",
			Arrays.asList("Project", "Ticket Issue ID", "Priority", "Created Date", "Issue Status")),

	NET_OPEN_TICKET_COUNT_BY_STATUS(
			"kpi48",
			Arrays.asList(
					"Project", "Day/Week/Month", "Ticket Issue ID", "Issue Status", "Created Date")),

	NET_OPEN_TICKET_COUNT_BY_RCA(
			"kpi51",
	...
	CODE_COMMIT_MERGE_KANBAN(
			"kpi65", Arrays.asList("Project Name", "Repo", "Branch", "Days/Weeks", "No Of Commit")),

	REPO_TOOL_CODE_COMMIT_MERGE_KANBAN(
			"kpi159",
			Arrays.asList("Project Name", "Repo", "Branch", "Developer", "Days/Weeks", "No Of Commit")),

	TEAM_CAPACITY_KANBAN(
			"kpi58",
			Arrays.asList("Project Name", "Start Date", "End Date", "Estimated Capacity (in hours)")),

	ISSUES_LIKELY_TO_SPILL(
			"kpi123",
			Arrays.asList(
					"Issue Id",
					"Issue Type",
	...
	ISSUE_HYGINE(
			"kpi124",
			Arrays.asList(
					"Issue Id", "Issue Description", "Issue Status", "Issue Type", "Assignee", "Category")),
	...
	WORK_STATUS(
			"kpi128",
			Arrays.asList(
					new KPIExcelColumnInfo("Issue Id", ""),
					new KPIExcelColumnInfo("Issue Description", ""),
					new KPIExcelColumnInfo("Issue Status", ""),
					new KPIExcelColumnInfo("Issue Type", ""),
					new KPIExcelColumnInfo("Size(story point/hours)", ""),
					new KPIExcelColumnInfo("Original Estimate", ""),
					new KPIExcelColumnInfo("Remaining Estimate", ""),
					new KPIExcelColumnInfo("Due Date", ""),
					new KPIExcelColumnInfo("Actual Start Date", ""),
					new KPIExcelColumnInfo("Dev Completion Date", ""),
					new KPIExcelColumnInfo("Actual Completion Date", ""),
					new KPIExcelColumnInfo(
							"Delay(in days)",
					...
					new KPIExcelColumnInfo("Potential Delay(in days)", ""),
					new KPIExcelColumnInfo("Assignee", ""),
					new KPIExcelColumnInfo("Category", ""))),
	...
	FIRST_TIME_PASS_RATE_ITERATION(
			"kpi135",
			Arrays.asList(
					"Issue Id", "Issue Description", "First Time Pass", "Linked Defect", "Defect Priority")),
	...
	DEFECT_COUNT_BY_STATUS_RELEASE(
			"kpi141",
			Arrays.asList(
					"Issue ID",
					"Issue Description",
	...
	DEFECT_COUNT_BY_ASSIGNEE_RELEASE(
			"kpi143",
			Arrays.asList(
					"Issue ID",
					"Issue Description",
	...
	DEFECT_COUNT_BY_PRIORITY_RELEASE(
			"kpi144",
			Arrays.asList(
					"Issue ID",
					"Issue Description",
	...
	DAILY_STANDUP_VIEW(
			"kpi154",
			Arrays.asList("Remaining Capacity", "Remaining Estimate", "Remaining Work", "Delay")),
	...
	EPIC_PROGRESS(
			...
			Arrays.asList(
					...
					"Size(story point/hours)",
					"Epic Status",
					"To Do(Value/Percentage)",
					"In Progress(Value/Percentage)",
					"Done(Value/Percentage)")),

	BACKLOG_EPIC_PROGRESS(
			"kpi169",
			Arrays.asList(
					"Epic ID",
					"Epic Name",
	...
	CODE_QUALITY(
			"kpi168", Arrays.asList("Project", "Job Name / Pipeline Name", "Code Quality", "Month")),
	FLOW_EFFICIENCY(
			"kpi170",
			Arrays.asList(
					"Issue ID",
	...
	RELEASE_PLAN(
			...
			Arrays.asList(
					...
					"Assignee",
					"Issue Status",
					"Planned Completion Date (Due Date)")),
	DEFECT_COUNT_BY(
			"kpi178",
			Arrays.asList(
					"Issue ID",
	...
	E2E_TEST_PASS_RATE(
			"kpi218",
			Arrays.asList(
					"Weeks", "Project", "Suite Name", "Total Tests", "Passed", "Failed", "Pass Rate %")),
	;
	...
	KPIExcelColumn(String kpiID, List<Object> columns) {
		...
		if (columns.get(0) instanceof String) {
			...
			columns.forEach(
					o -> {
						KPIExcelColumnInfo kpiExcelColumnInfo1 =
								objectMapper.convertValue(o, KPIExcelColumnInfo.class);
	...
	public List<String> getColumns(
			List<Node> nodeList, CacheService cacheService, FilterHelperService filterHelperService) {
		Set<ObjectId> projectIds =
				nodeList.stream()
						.map(a -> a.getProjectFilter().getBasicProjectConfigId())
		...
		List<AccountHierarchyData> accountHierarchyData =
					...
					&& CollectionUtils.isNotEmpty(
							(accountHierarchyData)
									.stream()
											.filter(
													a ->
															addFilterCat.containsKey(a.getLabelName())
