...
public class KpiDataCacheServiceImpl implements KpiDataCacheService {
	...
	@Autowired KpiDataProvider kpiDataProvider;

	@CacheEvict(
			value = Constant.CACHE_PROJECT_KPI_DATA,
			key = "#basicProjectConfigId.concat('_').concat(#kpiId)")
	@Override
	...
	public List<String> getKpiBasedOnSource(String source) {
		...
		kpiMap.put(
				...
				List.of(
						...
						KPICode.TICKET_VELOCITY.getKpiId(),
						KPICode.LEAD_TIME_KANBAN.getKpiId(),
						KPICode.COST_OF_DELAY_KANBAN.getKpiId(),
						KPICode.PROJECT_RELEASES_KANBAN.getKpiId(),
		...
		kpiMap.put(
				KPISource.SONAR.name(),
				List.of(
						KPICode.SONAR_CODE_QUALITY.getKpiId(),
						KPICode.SONAR_TECH_DEBT.getKpiId(),
		...
		kpiMap.put(
				...
				List.of(
						KPICode.INSPRINT_AUTOMATION_COVERAGE.getKpiId(),
						...
						KPICode.TEST_EXECUTION_KANBAN.getKpiId()));
	...
	@Override
	public Map<String, Object> fetchIssueCountData(
	...
	@Cacheable(
			...
			key = "#basicProjectConfigId.toString().concat('_').concat(#kpiId)")
	@Override
	public Map<String, Object> fetchSprintPredictabilityData(
			KpiRequest kpiRequest, ObjectId basicProjectConfigId, List<String> sprintList, String kpiId) {
		log.info(
				"Fetching Sprint Predictability KPI Data for Project {} and KPI {}",
				basicProjectConfigId.toString(),
				kpiId);
		return kpiDataProvider.fetchSprintPredictabilityDataFromDb(
	...
	@Cacheable(
			...
			key = "#basicProjectConfigId.toString().concat('_').concat(#kpiId)")
	@Override
	public Map<String, Object> fetchDefectInjectionRateData(
			KpiRequest kpiRequest, ObjectId basicProjectConfigId, List<String> sprintList, String kpiId) {
		log.info(
				"Fetching DIR KPI Data for Project {} and KPI {}", basicProjectConfigId.toString(), kpiId);
		return kpiDataProvider.fetchDefectInjectionRateDataFromDb(
				kpiRequest, basicProjectConfigId, sprintList);
	}
	...
	@Cacheable(
			...
			key = "#basicProjectConfigId.toString().concat('_').concat(#kpiId)")
	@Override
	public Map<String, Object> fetchFirstTimePassRateData(
			KpiRequest kpiRequest, ObjectId basicProjectConfigId, List<String> sprintList, String kpiId) {
		log.info(
				"Fetching FTPR KPI Data for Project {} and KPI {}", basicProjectConfigId.toString(), kpiId);
		return kpiDataProvider.fetchFirstTimePassRateDataFromDb(
				kpiRequest, basicProjectConfigId, sprintList);
	}
	...
	@Cacheable(
			...
			key = "#basicProjectConfigId.toString().concat('_').concat(#kpiId)")
	@Override
	public Map<String, Object> fetchDefectDensityData(
			KpiRequest kpiRequest, ObjectId basicProjectConfigId, List<String> sprintList, String kpiId) {
		log.info(
				"Fetching Defect Density KPI Data for Project {} and KPI {}",
				basicProjectConfigId.toString(),
				kpiId);
		return kpiDataProvider.fetchDefectDensityDataFromDb(
				kpiRequest, basicProjectConfigId, sprintList);
	}
	...
	@Cacheable(
			...
			key = "#basicProjectConfigId.toString().concat('_').concat(#kpiId)")
	@Override
	public Map<String, Object> fetchSprintVelocityData(
			KpiRequest kpiRequest, ObjectId basicProjectConfigId, String kpiId) {
		log.info(
				"Fetching Sprint Velocity KPI Data for Project {} and KPI {}",
				basicProjectConfigId.toString(),
				kpiId);
	...
	public List<Build> fetchBuildFrequencyData(
		...
		log.info(
				"Fetching Build Frequency KPI Data for Project {} and KPI {}",
				basicProjectConfigId.toString(),
				kpiId);
	...
	@Cacheable(
			...
			key = "#basicProjectConfigId.toString().concat('_').concat(#kpiId)")
	@Override
	public Map<String, Object> fetchSprintCapacityData(
			KpiRequest kpiRequest, ObjectId basicProjectConfigId, List<String> sprintList, String kpiId) {
		log.info(
				"Fetching Sprint Capacity Utilization KPI Data for Project {} and KPI {}",
				basicProjectConfigId.toString(),
				kpiId);
		return kpiDataProvider.fetchSprintCapacityDataFromDb(
				kpiRequest, basicProjectConfigId, sprintList);
	}
	...
	public Map<String, Object> fetchScopeChurnData(
			KpiRequest kpiRequest, ObjectId basicProjectConfigId, List<String> sprintList, String kpiId) {
		log.info(
				"Fetching Scope Churn KPI Data for Project {} and KPI {}",
				basicProjectConfigId.toString(),
				kpiId);
	...
	public Map<String, Object> fetchCommitmentReliabilityData(
			KpiRequest kpiRequest, ObjectId basicProjectConfigId, List<String> sprintList, String kpiId) {
		log.info(
				"Fetching Commitment Reliability KPI Data for Project {} and KPI {}",
				basicProjectConfigId.toString(),
				kpiId);
		return kpiDataProvider.fetchCommitmentReliabilityData(
				kpiRequest, basicProjectConfigId, sprintList);
	}
	...
	public Map<String, Object> fetchCostOfDelayData(ObjectId basicProjectConfigId, String kpiId) {
		log.info(
				"Fetching Cost of Delay KPI Data for Project {} and KPI {}",
				basicProjectConfigId.toString(),
				kpiId);
	...
	public List<ProjectRelease> fetchProjectReleaseData(ObjectId basicProjectConfigId, String kpiId) {
		log.info(
				"Fetching Release Frequency KPI Data for Project {} and KPI {}",
				basicProjectConfigId.toString(),
				kpiId);
	...
	public List<JiraIssue> fetchPiPredictabilityData(ObjectId basicProjectConfigId, String kpiId) {
		log.info(
				"Fetching PI Predictability KPI Data for Project {} and KPI {}",
				basicProjectConfigId.toString(),
				kpiId);
	...
	public Map<String, Object> fetchCreatedVsResolvedData(
			KpiRequest kpiRequest, ObjectId basicProjectConfigId, List<String> sprintList, String kpiId) {
		log.info(
				"Fetching Created vs Resolved KPI Data for Project {} and KPI {}",
				basicProjectConfigId.toString(),
				kpiId);
	...
	@Cacheable(
			...
			key = "#basicProjectConfigId.toString().concat('_').concat(#kpiId)")
	@Override
	public Map<String, Object> fetchHappinessIndexData(
			ObjectId basicProjectConfigId, List<String> sprintList, String kpiId) {
		log.info(
				"Fetching Happiness Index KPI Data for Project {} and KPI {}",
				basicProjectConfigId.toString(),
				kpiId);
	...
	public Map<String, Object> fetchDRRData(
			KpiRequest kpiRequest, ObjectId basicProjectConfigId, List<String> sprintList, String kpiId) {
		log.info(
				"Fetching DRR KPI Data for Project {} and KPI {}", basicProjectConfigId.toString(), kpiId);
