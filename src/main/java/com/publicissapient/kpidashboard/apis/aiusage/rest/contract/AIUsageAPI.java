...
public interface AIUsageAPI {
	...
	@GetMapping("/stats")
	@Operation(summary = "Get Latest AI Usage Metrics by Level Name",
	...
	ResponseEntity<List<AIUsageStatisticsDTO>> getAIUsageStats(
			@Parameter(description = "Hierarchy level name", required = true,
					example = "acc / ver / bu")
			@RequestParam String levelName,
			@Parameter(description = "Flag to include user-level AI usage details in the response",
					example = "true")
