...
public class CacheStatisticsController {
    ...
    public Map<String, Object> getCacheStatistics() {
        ...
        try {
            ...
            String[] importantCaches = {
                "accountHierarchy", "accountHierarchyKanban", "sprintHierarchy",
                "projectConfigMap", "filters", "hierarchyLevelCache", "projectToolConfigMap"
            };
    ...
    public Map<String, Object> getDetailedCacheCount() {
        ...
        try {
            ...
            String[] criticalCaches = {
                "accountHierarchy", "accountHierarchyKanban", "sprintHierarchy",
                "projectConfigMap", "filters", "hierarchyLevelCache"
            };
    ...
    public Map<String, Object> getCacheCountComparison() {
        ...
        try {
            ...
            if (cache != null) {
                ...
                comparison.put("memoryPressure", memoryUsagePercent > 75 ? "HIGH" : memoryUsagePercent > 50 ? "MEDIUM" : "LOW");
                
                // Recommendation based on count and memory
                if (currentCount == 0 && memoryUsagePercent > 75) {
                    comparison.put("recommendation", "Cache is empty due to memory pressure. Consider switching to entries-based configuration.");
                } else if (currentCount == 0) {
                    comparison.put("recommendation", "Cache is empty but memory usage is normal. Check cache loading logic.");
                } else if (currentCount == -1) {
                    comparison.put("recommendation", "Cannot determine cache count. Cache may not be an Ehcache instance.");
                } else {
    ...
    public Map<String, Object> getGCInfo() {
        ...
        try {
            ...
            gcInfo.put("usedMemory", (runtime.totalMemory() - runtime.freeMemory()) / (1024 * 1024) + " MB");
